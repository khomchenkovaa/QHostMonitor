...
void ReportsOptionsWidget::init(QSettings *s)
{
    ...
    ui->cmbCreateReport_1->setCurrentText(s->value(SKEY_REPORTS_ReportType1).toString());
    ...
    ui->cmbCreateReport_2->setCurrentText(s->value(SKEY_REPORTS_ReportType2).toString());
    ui->editReportFile_2->setText(s->value(SKEY_REPORTS_ReportFile2,curFolder + "dbf-full.dbf").toString());

    ui->chkCreateReport_3->setChecked(s->value(SKEY_REPORTS_CreateReport3,1).toInt());
    ui->cmbCreateReport_3->setCurrentText(s->value(SKEY_REPORTS_ReportType3).toString());
    ...
    ui->cmbCreateReport_4->setCurrentText(s->value(SKEY_REPORTS_ReportType4).toString());
    ...
    ui->cmbCreateReport_5->setCurrentText(s->value(SKEY_REPORTS_ReportType5).toString());
    ui->editReportFile_5->setText(s->value(SKEY_REPORTS_ReportFile5,curFolder + "dbf-full.dbf").toString());

    ui->chkCreateReport_6->setChecked(s->value(SKEY_REPORTS_CreateReport6,1).toInt());
    ui->cmbCreateReport_6->setCurrentText(s->value(SKEY_REPORTS_ReportType6).toString());
    ui->editReportFile_6->setText(s->value(SKEY_REPORTS_ReportFile6,curFolder + "dbf-full.dbf").toString());
